...
/**
 * 使用SockJS和Stomp客户端连接到Spring Boot配置的/ws端点
 * @param event
 */
...
function onMessageReceived(payload) {
    ...
    if(message.type === 'JOIN') {
        ...
        message.content = message.sender + ' 进入聊天室!';
        ...
        if(message.sender === "admin"){
            ...
            const template = "<img src=\"http://tmp.wyjsjxh.com/202011162112_275.jpg\" style=\"\n" +
                "    width: 50px;\n" +
                "    height: 50px;\n" +
                "    margin: -5px;\n" +
                "\">"
